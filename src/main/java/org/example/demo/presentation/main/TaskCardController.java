...
/**
 * Контроллер для карточки задачи.
 */
public class TaskCardController {
    ...
    /**
     * Устанавливает задачу и инициализирует контроллер.
     *
     * @param task задача для отображения
     * @param taskService сервис управления задачами
     * @param isSubtask индикатор, является ли задача подзадачей
     * @param refreshCallback действие для обновления после изменений
     */
    ...
    /**
     * Обновляет пользовательский интерфейс карточки задачи.
     */
    ...
    /**
     * Настраивает раздел для подзадач.
     */
    ...
    /**
     * Загружает подзадачи и обновляет отображение контейнера подзадач.
     */
    ...
    /**
     * Добавляет карточку подзадачи в контейнер.
     *
    ...
    /**
     * Переключает видимость контейнера подзадач.
     */
    @FXML
    ...
    /**
     * Раскрывает контейнер подзадач с анимацией.
     */
    ...
    /**
     * Сворачивает контейнер подзадач с анимацией.
     */
    ...
    /**
     * Обрабатывает событие пометки задачи как выполненной.
     */
    @FXML
    ...
    /**
     * Отображает уведомление о выполнении задачи.
     */
