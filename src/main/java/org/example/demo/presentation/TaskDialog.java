 ...
 *
 * Включает форму для ввода названия, описания, приоритета, дедлайна и исполнителя.
 */
public class TaskDialog extends Dialog<Task> {
    ...
    /**
     * Конструктор для создания нового диалога задачи.
     *
     * @param projectName название проекта, к которому будет привязана задача
     */
    ...
    /**
     * Конструктор для создания или редактирования существующей задачи.
     *
     * @param projectName название проекта, к которому будет привязана задача
     * @param existingTask задача, которую необходимо редактировать; если null, создается новая задача
     */
    ...
    /**
     * Валидация формы ввода. Отключает или включает кнопку в зависимости
     * от заполненности полей заголовка и описания.
     *
     * @param button кнопка, состояние которой нужно изменить
     * @param title поле для ввода заголовка задачи
     * @param description поле для ввода описания задачи
     */
    ...
    /**
     * Отображение диалогового окна с сообщением об ошибке ввода.
     *
